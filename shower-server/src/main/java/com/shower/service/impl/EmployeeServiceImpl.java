...
import com.shower.constant.PasswordConstant;
...
import com.shower.exception.AccountLockedException;
import com.shower.exception.AccountNotFoundException;
import com.shower.exception.PasswordErrorException;
import com.shower.mapper.EmployeeMapper;
import com.shower.result.PageResult;
import com.shower.service.EmployeeService;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void save(EmployeeDTO employeeDTO) {
        ...
        //设置账号状态，默认正常状态。1正常，0锁定，使用状态常量
        employee.setStatus(StatusConstant.ENABLE);

        //设置密码，默认123456，且使用md5加密。使用密码常量
