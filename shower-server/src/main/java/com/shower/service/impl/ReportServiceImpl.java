...
import com.shower.dto.GoodsSalesDTO;
...
import com.shower.service.WorkspaceService;
import com.shower.vo.*;
...
public class ReportServiceImpl implements ReportService {
    ...
    public void exportBusinessData(HttpServletResponse response) {
        ...
        try {
            ...
            //填充明细数据
            for(int i = 0; i < 30; i++) {
                LocalDate orderDate = dateBegin.plusDays(i);
                BusinessDataVO businessData = workspaceService.getBusinessData(LocalDateTime.of(orderDate, LocalTime.MIN), LocalDateTime.of(orderDate, LocalTime.MAX));
                row = sheet.getRow(7 + i);
                row.getCell(1).setCellValue(orderDate.toString());
